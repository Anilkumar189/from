...
function Studentform(){
    var Studentform=useFormik({
        ...
        //     .required("please fill the firstname it is mandatory")
        //     .max(5,"please check"),
        //     lastname:yup.string()
    ...
    return <div>
        <form  onSubmit={Studentform.handleSubmit}>
            ...
            <button onClick={()=>{Studentform.setValues({ firstname:"anil kumar",
            lastname:"yandrapu",
            age:"24",
            password:"123456",
            username:"dady"})}}>show values</button>
             <button onClick={()=>{Studentform.setFieldValue("lastname","dharamavarapu")}}>show lastname</button>
        </form>
